...
class _BookingConfirmedScreenState extends State<BookingConfirmedScreen> {
  ...
  void _onTimerFinished() {
    // when countdown reaches 0, we can transition to unlock or active rental
    // For now, we keep user on the screen when countdown reaches 0"
  }
  ...
  Widget build(BuildContext context) {
    ...
    final rental = rideVm.bookedRental;
          ...
          child: Column(
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        const Text('Station', style: TextStyle(color: Colors.grey, fontSize: 12)),
                        Row(
                          children: List.generate(
                            ...
                            (index) => Icon(
                              Icons.star_rounded,
                              size: 16,
                              color: index < 4 ? Colors.red : Colors.grey.shade300,
                            ),
                          ),
                        ),
                      ],
                    ...
                    Text(stationName, style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 18)),
                    const SizedBox(height: 4),
                    Text('Bike ID: #$displayBikeId', style: const TextStyle(color: Colors.grey, fontSize: 14)),
              ...
              SizedBox(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Text(
                      '$_secondsRemaining',
                      style: const TextStyle(fontSize: 64, fontWeight: FontWeight.w800, color: Color(0xFF333333)),
                    ),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.notifications_none_rounded, color: Colors.red, size: 24),
