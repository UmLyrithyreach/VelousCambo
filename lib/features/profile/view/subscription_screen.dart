        ...
        builder: (context, viewModel, _) {
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              title: const Text('Unlock Unlimited Rides', style: AppTextStyles.headlineSmall),
              centerTitle: true,
            ),
            body: SafeArea(
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isSelected = viewModel.state.selectedPlan == plan.type;
                    ...
                    _SubscriptionFooter(
                      ...
                      onPurchase: () => viewModel.purchasePlan(),
                    ),
                  ],
                ),
              ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(plan.priceLabel, style: AppTextStyles.headlineMedium.copyWith(color: plan.color)),
